...
Kirki::add_section( 'registration', array(
	...
	Kirki::add_field( 'workscout', array(
	    'type'        => 'switch',
	    'settings'    => 'pp_woo_recaptcha',
	    'label'       => esc_html__( 'Add reCAPTCHA field to registration form', 'workscout' ),
	    'section'     => 'registration',
	    'description' => esc_html__( 'If set to "On" it will add reCAPTCHA field (add API keys in Job Listings -> Settings ->reCAPTCHA)', 'workscout' ),
	    'default'     => false,
	    'priority'    => 10,
	    'active_callback'  => array(
			array(
