<?php 
        ...
        <?php } ?>  
            ...
            <fieldset>
                ...
                <?php 
                    ...
                    if ( $privacy_policy_status && function_exists( 'the_privacy_policy_link' ) ) { ?>
                        <p class="form-row margin-top-10 margin-bottom-10">
                            <label for="privacy_policy"><input type="checkbox" id="privacy_policy" name="privacy_policy"><?php esc_html_e( 'By signing up I agree to the terms and conditions as outlined in our', 'workscout_core' ); ?> <a target="_blank" href="<?php echo get_privacy_policy_url(); ?>"><?php esc_html_e( 'Privacy Policy', 'workscout_core' ); ?></a>    </label>
                ...
                <p>
                    Already have an account? <a href="<?php echo get_site_url() ;?>?action=login">Login</a>
                </p>
