...
<?php } ?>
    ...
    <fieldset>
        ...
        <p>
            <?php esc_html_e('Don\'t have an account?','workscout_core'); ?> <a href="<?php echo get_permalink(); ?>?action=register"><?php esc_html_e('Sign up as a Job Seeker now!','workscout_core'); ?></a>
        </p>
        ...
        <p>
            <a href="<?php echo home_url( 'lost-password' ); ?>" title="<?php esc_attr_e('Lost Password?','workscout_core'); ?>"><?php esc_html_e('Lost Password?','workscout_core'); ?></a>
         </p>
