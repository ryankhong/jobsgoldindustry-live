	...
	<div class="header-notifications-trigger">
		<a href="#">
			<div class="user-avatar status-online">
				<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/profile-pic.jpg" alt="<?php echo $name; ?>" />
			</div>
	...
	<div class="header-notifications-dropdown">
		<ul class="user-menu-small-nav">
			<?php $dashboard_page = get_option('workscout_dashboard_page');  if( $dashboard_page ) : ?>
				...
				?>
                <li data-role="<?php echo $role; ?>" <?php if( is_page() && $post->ID == $dashboard_page ) : ?>class="active" <?php endif; ?>><a href="<?php echo esc_url(get_permalink($dashboard_page)); ?>"> <?php esc_html_e('Dashboard','workscout_core');?></a></li>
                <?php endif; ?>
