...
<form class="job_filters in_sidebar">
	...
	<div class="widget job-widget-company" <?php if($job_categories_widget == "off") : echo ' style="display:none;" '; endif; ?>>

		<h4><?php esc_html_e('Company','workscout'); ?></h4>

		<div class="search_company">

			<?php 

				$companies = get_post_meta(4024, 'options', true);

				?>
				
				<select class="select2-multiple job-manager-category-dropdown  select2-hidden-accessible" name="search_keywords" id="comany_name">

				<option name="all" value="" selected="selected">All</option>
			...
			<script>
				...
				jQuery(document).ready(function() {
					...
					jQuery('span.select2-search').hide();
	...
	<div class="widget job-widget-date">

		<h4>Date Posted</h4>

		<div class="sort_by_date">

			<select class="select2-multiple job-manager-category-dropdown  select2-hidden-accessible" name="sort_by_date" id="order_by_date">

				<option name="date" value="ASC" selected="selected">Newest First</option>
				<option name="date" value="DESC">Oldest First</option>
	...
	<?php if(get_query_var( '_company_name')) {?>
		<input type="hidden" name="company_field" value="<?php echo urldecode( get_query_var( '_company_name') ) ?>">
	<?php } ?>
...
<!--div id="listings-loader1">
<ul class="job_listings job-list full  new-layout1"></ul>
</div-->
