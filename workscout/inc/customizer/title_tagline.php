<?php 
	...
	// Kirki::add_field( 'workscout', array(
	// 	'type'        => 'slider',
	// 	'settings'    => 'pp_retina_logo_width',
	// 	'label'       => esc_html__( 'Logo image max width', 'workscout' ),
	// 	'description' => esc_html__( 'Set image width for retina version in case the logo is displayed too big', 'workscout' ),
	// 	'section'     => 'title_tagline',
	// 	'default'     => '65',
	// 	'choices'     => array(
	// 		'min'  => '0',
